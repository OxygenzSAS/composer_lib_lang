...
namespace OxygenzSAS\Lang;

class Lang implements \OxygenzSAS\Interfaces\LangInterface
{

    private $lang;
    private $bdd;

    public function __construct($lang, \OxygenzSAS\Interfaces\BddInterface $bdd){
        $this->lang = $lang;
        $this->bdd = $bdd;
    }
